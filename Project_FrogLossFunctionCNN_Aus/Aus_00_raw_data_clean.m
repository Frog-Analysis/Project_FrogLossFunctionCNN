...
close all; clear; clc;
%======================%
label_array_org = [1:23];
%======================%
fs = 44100;
audio_folder = ['.\Australia-Frog\data_split\'];
%======================%
...
for iSize = 1:nSize
    ...
    for iOver = 1:nOver
        ...
        for iPerc = 1:nPerc
            ...
            training_len_array = csvread(['.\Australia-Frog\training_len_folder\training_len_', num2str(temp_percent), '.csv']);
            ...
            for iTrainingList = 1:nTrainingList
                ...
                frog_name = frog_name(1:end-5);
                label_path = [label_folder, label_list(iTrainingList).name];
                
                label_data = ground_truth_Australia(label_path, frog_name, fs);
                ...
                %% save data
                save_final_folder = ['.\Australia-Frog\0409_raw_data_clean\percent_', num2str(temp_percent), '_winsize_', num2str(win_size), '_winover_',  num2str(win_over), '\', frog_name];
