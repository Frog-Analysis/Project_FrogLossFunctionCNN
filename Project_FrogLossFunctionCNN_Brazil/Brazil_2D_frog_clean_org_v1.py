        ...
        for select_win_len in win_len_array:
            ...
            for select_win_over in win_over_array:
                ...
                for iRepeat in range(nRepeat):                    
                    ...
                    test_feature_final, test_label_final = vector_to_matrix(test_feat, testLabel, num_classes, S)
                                    
                    #===========================#
                    # loss function
                    loss_fun_array = ['focal']          
                    # loss_fun_array = ['my_cross_entropy','w_cross_entropy', 'twin_loss']          
                    ...
                    for iLoss in range(nLoss):   
                        ...
                        '''
                        # checkpoint
                        save_weight_folder = os.path.join('./tmp0429/2D_Brazil_org/',tmp_loss)
                        ...
                        save_folder = './0429/'             
                        save_folder_final = save_folder + '/2D_Brazil_org/' + repeat_name + '/' + label_type + '_' + tmp_loss + \
