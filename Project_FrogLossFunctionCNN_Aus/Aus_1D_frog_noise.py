...
def feature_extraction(_base_folder, _percent_value, _select_win_len, _select_win_over):
    ...
    for iData in range(2):
        ...
        if iData == 0:
            train_data_mat = train_data
        elif iData == 1:
            test_data_mat = train_data
            ...
            for idx in range(len(percent_array)):
                ...
                for select_win_len in win_len_array:
                    ...
                    for select_win_over in win_over_array:
                        ...
                        train_data, test_data = feature_extraction(noise_folder, select_percent, select_win_len, select_win_over)
                        ...
                        for iLoss in range(nLoss):   
                            ...
                            '''
                            # checkpoint
                            save_weight_folder = os.path.join('./tmp_0421/1D_Aus_org_noise/',tmp_loss)
                            ...
                            save_folder = './0421/'             
                            save_folder_final = save_folder + '/1D_Aus_org_noise/'+ noise + '_' + str(snr) + '/' + \
