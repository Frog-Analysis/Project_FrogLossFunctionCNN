...
method_list = []
acc_focal_list = []
focal_folder = r'.\0421\1D_2D_Brazil_org_focal_1e-4'
focal_list = os.listdir(focal_folder)
for focal_name in focal_list:
    
    
    # focal_path = os.path.join(focal_folder, focal_name, 'result_all_percent_0.8_winsize_8820_winover_0.8',
    #                           'accuracy_fscore_kappa.csv')
    focal_path = os.path.join(focal_folder, focal_name, 'result_all_percent_0.8_winsize_0.2_winover_0.8',
                              'accuracy_fscore_kappa.csv')
...
im, cbar = heatmap(acc_focal_mat, alpha, gamma, ax=ax,
                   cmap="YlGn")
...
plt.savefig(save_folder + '1D_2D_Brazil_org_focal.png')
