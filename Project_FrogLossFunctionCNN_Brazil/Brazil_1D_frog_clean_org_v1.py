        ...
        for select_win_len in win_len_array:
            ...
            for select_win_over in win_over_array:
                ...
                for iRepeat in range(nRepeat):                    
                    ...
                    #===========================#
                    training_feat, validation_feat, test_feat = feat_normalization(training_feat, 
                                                                                   validation_feat, test_feat)    
                    ...
                    #===========================#
                    # loss_fun_array = ['w_cross_entropy', 'twin_loss','my_cross_entropy']          
                    ...
                    for iLoss in range(nLoss):   
                        ...
                        if tmp_loss == 'w_cross_entropy':
                            ...
                            alpha_value, gamma_value = 0.25, 4         
                            my_loss_fun = my_loss_selection.select_loss(tmp_loss, training_label_org, 
                                                                        num_classes, alpha_value, gamma_value)
                        ...
                        '''
                        # checkpoint
                        save_weight_folder = os.path.join('./tmp0421/1D_Brazil_org/',tmp_loss)
                        ...
                        save_folder = './0429/'             
                        save_folder_final = save_folder + '/1D_Brazil_org/' + repeat_name + '/' + label_type + '_' + tmp_loss + \
