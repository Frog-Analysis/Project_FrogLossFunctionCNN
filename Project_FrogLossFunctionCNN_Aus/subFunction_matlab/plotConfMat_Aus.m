...
figure('Renderer', 'painters', 'Position', [50 50 1200 1200])
...
% plotting the colors
imagesc(confpercent);
% title(sprintf('Accuracy: %.1f%%', 100*trace(confmat)/sum(confmat(:))));
...
set(gca, 'XTick', 1:24, ...                             
    'XTickLabel', {'BN','ADI', 'CPA', 'CSA', 'LTS', 'LTE','LCA', 'LCS', 'LFX', 'LGA', 'LLA', 'LNA', 'LRA', 'LTI', 'LVI','MFS','MFI','NSI','PKN','PCA','PRI','RSS','UFA', 'ULA'}, ...  %   and tick labels
    'YTick', 1:24, ...
    'YTickLabel', {'BN', 'ADI', 'CPA', 'CSA', 'LTS', 'LTE','LCA', 'LCS', 'LFX', 'LGA', 'LLA', 'LNA', 'LRA', 'LTI', 'LVI','MFS','MFI','NSI','PKN','PCA','PRI','RSS','UFA', 'ULA'}, ...
    'TickLength', [0 0]);
set(gcf,'color','w');
