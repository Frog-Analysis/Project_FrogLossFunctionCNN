    ...
    for idx in range(len(percent_array)):
        ...
        for select_win_len in win_len_array:
            ...
            for select_win_over in win_over_array:
                ...
                train_index, test_index = train_test_split(sample_index, test_size=0.2, stratify=train_label)
                
                training_index, validation_index = train_test_split(train_index, test_size=0.25, stratify=train_label)
                ...
                # aa1, aa2 = np.unique(training_label_org, return_counts=True)
                # print(aa1)
                ...
                for iLoss in range(nLoss):   
                    ...
                    for alpha_value in alpha_array:
                        ...
                        for gamma_value in gamma_array:
                            ...
                            save_folder = './0429/'             
                            save_folder_final = save_folder + '/1D_2D_Aus_org_focal_1e-4/' + label_type + '_' + tmp_loss + \
