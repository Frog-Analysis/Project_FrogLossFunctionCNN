        ...
        for select_win_len in win_len_array:
            ...
            for select_win_over in win_over_array:
                ...
                for iRepeat in range(nRepeat):                    
                    ...
                    loss_fun_array = ['w_cross_entropy', 'my_cross_entropy','twin_loss', 'focal']          
                    ...
                    for iLoss in range(nLoss):   
                        ...
                        '''
                        # checkpoint
                        save_weight_folder = os.path.join('./tmp_0429/1D_Aus_org/',tmp_loss)
                        ...
                        save_folder = './0429/'             
                        save_folder_final = save_folder + '/1D_Aus_org/' + repeat_name + '/' + \
