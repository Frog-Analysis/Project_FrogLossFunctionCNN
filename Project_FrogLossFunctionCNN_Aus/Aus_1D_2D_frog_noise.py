...
def feature_extraction(_base_folder, _percent_value, _select_win_len, _select_win_over):
    ...
    for iAudio in range(nAudio):    
        ...
        audio_path = os.path.join(species_folder, species_list[iAudio])
        
        #===========#                              
        train_data_single = pd.read_csv(audio_path, low_memory=False, header=None)                
        ...
        #===========#
        if iAudio == 1:
            test_data_list, test_data_list_waveform = train_data_list, train_data_list_waveform, 
            ...
            for idx in range(len(percent_array)):
                ...
                for select_win_len in win_len_array:
                    ...
                    for select_win_over in win_over_array:
                        ...
                        train_data_list, test_data_list, train_data_list_waveform, test_data_list_waveform, S = feature_extraction(noise_folder, select_percent, select_win_len, select_win_over)
                        ...
                        training_feat = std_scaler.fit_transform(training_feat)
                        validation_feat = std_scaler.fit_transform(validation_feat)
                        ...
                        for iLoss in range(nLoss):   
                            ...
                            '''
                            # checkpoint
                            save_weight_folder = os.path.join('./tmp_0421/1D_2D_Aus_org_noise/',tmp_loss)
                            ...
                            save_folder = './0421/'             
                            save_folder_final = save_folder + '/1D_2D_Aus_org_noise/'+ noise + '_' + str(snr) + '/' + \
