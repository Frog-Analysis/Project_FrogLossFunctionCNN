        ...
        for select_win_len in win_len_array:
            ...
            for select_win_over in win_over_array:
                ...
                for iRepeat in range(nRepeat):                    
                    ...
                    std_scaler = StandardScaler(copy=False).fit(training_feat_waveform)
                    training_feat_waveform = std_scaler.transform(training_feat_waveform)
                    validation_feat_waveform = std_scaler.transform(validation_feat_waveform)
                    testFeature_waveform = std_scaler.transform(test_feat_waveform)
                    ...
                    loss_fun_array = ['my_cross_entropy', 'focal']  
                    # loss_fun_array = ['w_cross_entropy','twin_loss']                  
                    ...
                    for iLoss in range(nLoss):   
                        ...
                        '''
                        # checkpoint
                        save_weight_folder = os.path.join('./tmp0421/1D_2D_Brazil_org/',tmp_loss)
                        ...
                        save_folder = './0429/'             
                        save_folder_final = save_folder + '/1D_2D_Brazil_org/' + repeat_name + '/' + label_type + '_' + tmp_loss + \
